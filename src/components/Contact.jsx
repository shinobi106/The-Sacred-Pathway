  ...
  return (
    ...
    flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        className="flex-[0.75] bg-white p-8 
        rounded-2xl"
      >
        ...
        >
          <label className="flex flex-col">
              ...
              <input 
                ...
                className="bg-[#D8D8D8] py-4 px-6 placeholder:text-secondary text-white rounded-lg 
          ...
          <button type="submit" 
            className="bg-[#D8D8D8] py-3 px-8 outline-none w-fit text-white font-bold
